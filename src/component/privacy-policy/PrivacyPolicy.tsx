...
export default function PrivacyPolicy() {
  ...
  const [objPrivacyPolicy, setObjPrivacyPolicy] = React.useState<any>(null);
  ...
  const getTitle = async (id: string) => {
    try {
      const res = await ApiServices.getPrivacyPolicy(id);
      setObjPrivacyPolicy(res);
  ...
  const onSubmit = async (data: any) => {
    if (objPrivacyPolicy !== null) {
      await ApiServices.update_PrivacyPolicy(data, id);
      alert("Updated Succeesfully");
    } else {
      await ApiServices.add_PrivacyPolicy(data);
            ...
            <div>
              <FormControl error={!!errors.language} fullWidth>
                ...
                <Controller
                  ...
                  control={control}
                  defaultValue={
                    objPrivacyPolicy?.title ? objPrivacyPolicy?.title : ""
                  }
                  render={({ field }) => (
                    <Select
